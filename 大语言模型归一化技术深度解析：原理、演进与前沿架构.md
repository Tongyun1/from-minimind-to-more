...
这是一个非常扎实的理论综述。为了帮助读者从“数学公式”跨越到“实际应用”，我在原文本的基础上插入了 **PyTorch 代码示例**。

这些代码不仅展示了公式是如何转化为代码的，还通过数值实验验证了你提到的“重中心化”和“重缩放”不变性。
...
### 8.1 Sandwich-Norm：CogView 的“三明治”防线
